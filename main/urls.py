...
from main.views import register, login_user, logout_user, edit_product, delete_product, login_ajax, register_ajax
from main.views import create_product_ajax, edit_product_ajax, delete_product_ajax
